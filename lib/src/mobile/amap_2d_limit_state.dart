...
import 'package:flutter_2d_amap/src/mobile/amap_2d_limit_controller.dart';
import 'package:flutter_2d_amap/src/mobile/amap_2d_multiple_annotation_controller.dart';

class AMap2DLimitViewState extends State<AMap2DLimitView> {
  ///Completer已经说明一切了
  final Completer<AMap2DLimitController> _controller =
      Completer<AMap2DLimitController>();

  /////Callback to invoke after the platform view has been created.
  void _onPlatformViewCreated(int id) {
    print('iOS视图创建完成1, 准备controller');
    final AMapMobile2DLimitController controller =
        AMapMobile2DLimitController.customInit(id, widget);
  ...
  Widget build(BuildContext context) {
    if (defaultTargetPlatform == TargetPlatform.android) {
      ...
      return UiKitView(
        viewType: 'plugins.zhangyu/flutter_2d_limit_uiview', //字符串类型 唯一标识符
        onPlatformViewCreated: _onPlatformViewCreated,
...
class _CreationParams {
  ...
  ///静态初始化方法
  static _CreationParams fromWidget(AMap2DLimitView widget) {
